        ...
        if($vacios==4){
            ...
            if(!empty($deporte))
            {
                ...
                if($result->num_rows>=1)
                {
                    ...
                    {
                        echo "<tr>";
                        echo "<form action='graficar_admin.php' method='post'>";/////////////////////////////////cambiar a grafico
                        ...
                        echo '<input type="hidden" name="codigoo" value='.$row['codigo'].'></td>';
                        echo '<input type="hidden" name="correoo" value='.$row['correo_contacto'].'></td>'; 
                         echo '<input type="hidden" name="idd" value='.$row['id'].'></td>';
            ...
            estar empty.*/
                ...
                if($result->num_rows>0)
                {
                    ...
                    {
                        echo "<tr>";
                        echo "<form action='graficar_admin.php' method='post'>";
                        echo "<td>".$row['codigo']."</td>";
                        echo "<td>".$row['nombre']."</td>";
                        echo "<td>".$row['apellido_p']."</td>";
                        echo "<td>".$row['deporte']."</td>";
