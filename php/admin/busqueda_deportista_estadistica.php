<div class="container" id="busqueda_deportista_estadistica" style="display:none;width:60%;border:2px solid #000;margin-top:20px">
        <h2 class="text-center">B&uacute;squeda de deportista</h2>
        <form class="form-horizontal" action="admin/listado_deportista_estadistica.php" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="hidden" name="correoo" id="correog" value="<?php echo $correo; ?>">
                     <input type="hidden" name="codigoo" id="codigo" value="<?php echo $codigo; ?>">
                </div>
            </div>
            <div class="form-group">
