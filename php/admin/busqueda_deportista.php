<div class="container" id="busqueda_deportista" style="display:none;width:60%;border:2px solid #000;margin-top:20px">
        <h2 class="text-center">B&uacute;squeda de deportista</h2>
        <form class="form-horizontal" action="admin/listado_deportista.php" method="post">
